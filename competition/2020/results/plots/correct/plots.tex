...
\begin{document}
        \begin{center}
             Quantile plot for 79 benchmarks: Storm(58/79).Default configuration.
            \quantileplot{janitools.csv}{Storm}
        \end{center}
                
        \begin{center}
             Quantile plot for 79 benchmarks: Storm(58/79).Specific configuration.
            \quantileplot{specificjanitools.csv}{Storm}
        \end{center}
                \pagebreak

        \begin{center}
             Quantile plot for 79 benchmarks: Storm(58/79).Default configuration.
            \quantileplot{generalpurpose.csv}{Storm}
        \end{center}
                
        \begin{center}
             Quantile plot for 79 benchmarks: Storm(58/79).Specific configuration.
            \quantileplot{specificgeneralpurpose.csv}{Storm}
        \end{center}
                \pagebreak

        \begin{center}
             Quantile plot for 100 benchmarks: Storm(58/79).Default configuration.
            \quantileplot{all.csv}{Storm}
        \end{center}
                
        \begin{center}
             Quantile plot for 100 benchmarks: Storm(58/79).Specific configuration.
            \quantileplot{specificall.csv}{Storm}
        \end{center}
                \pagebreak
