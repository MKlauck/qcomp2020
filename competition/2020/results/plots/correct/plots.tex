\documentclass{article}
    ...
    \begin{document}
            ...
            \begin{center}
                ...
                \scatterplot{scatterStorm.csv}{Storm}{\tool{Storm}  (default, fastest on 58/79)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm with specific settings (n=79).
                \scatterplot{scatterspecificStorm.csv}{Storm}{\tool{Storm}  (specific, fastest on 58/79)}
            \end{center}
                \pagebreak

            \begin{center}
                Scatter Plot for Storm-static with default settings (n=79).
                \scatterplot{scatterStorm-static.csv}{Storm-static}{\tool{Storm-static}  (default, fastest on 44/79)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm-static with specific settings (n=79).
                \scatterplot{scatterspecificStorm-static.csv}{Storm-static}{\tool{Storm-static}  (specific, fastest on 60/79)}
            \end{center}
                \pagebreak

        \begin{center}
            Scatter Plot for Storm vs. Storm-static with default settings (n=79).
            \scatterplot{scatter_storm_vs_static.csv}{Storm}{\tool{Storm}  (default, fastest on 52/79)}
        \end{center}
            
        \begin{center}
            Scatter Plot for Storm vs. Storm-static with specific settings (n=79).
            \scatterplot{scatter_storm_vs_staticspecific.csv}{Storm}{\tool{Storm}  (specific, fastest on 28/79)}
        \end{center}
            \pagebreak
\end{document}
