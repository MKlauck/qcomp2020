\documentclass{article}
    ...
    \begin{document}
            \begin{center}
                Quantile plot for 79 benchmarks: Storm(58/79), Storm-static(44/79).Default configuration.
                \quantileplot{janitools.csv}{Storm,Storm-static}
            \end{center}
                    
            \begin{center}
                Quantile plot for 79 benchmarks: Storm(58/79), Storm-static(60/79).Specific configuration.
                \quantileplot{specificjanitools.csv}{Storm,Storm-static}
            \end{center}
                    \pagebreak

            \begin{center}
                Quantile plot for 79 benchmarks: Storm(58/79), Storm-static(44/79).Default configuration.
                \quantileplot{generalpurpose.csv}{Storm,Storm-static}
            \end{center}
                    
            \begin{center}
                Quantile plot for 79 benchmarks: Storm(58/79), Storm-static(60/79).Specific configuration.
                \quantileplot{specificgeneralpurpose.csv}{Storm,Storm-static}
            \end{center}
                    \pagebreak
            ...
            \begin{center}
                ...
                \scatterplot{scatterStorm.csv}{Storm}{\tool{Storm}  (default, fastest on 52/79)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm with specific settings (n=79).
                \scatterplot{scatterspecificStorm.csv}{Storm}{\tool{Storm}  (specific, fastest on 28/79)}
            \end{center}
                \pagebreak
