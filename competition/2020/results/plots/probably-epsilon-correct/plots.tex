\documentclass{article}
    ...
    \begin{document}
            \begin{center}
                Quantile plot for 67 benchmarks: mcsta(53/67), Storm(61/67).Default configuration.
                \quantileplot{janitools.csv}{mcsta,Storm}
            \end{center}
                    
            \begin{center}
                Quantile plot for 67 benchmarks: mcsta(55/67), Storm(61/67).Specific configuration.
                \quantileplot{specificjanitools.csv}{mcsta,Storm}
            \end{center}
                    \pagebreak

            \begin{center}
                Quantile plot for 38 benchmarks: mcsta(32/38), Storm(38/38), PRISM(31/38).Default configuration.
                \quantileplot{generalpurpose.csv}{mcsta,Storm,PRISM}
            \end{center}
                    
            \begin{center}
                Quantile plot for 38 benchmarks: mcsta(33/38), Storm(38/38), PRISM(33/38).Specific configuration.
                \quantileplot{specificgeneralpurpose.csv}{mcsta,Storm,PRISM}
            \end{center}
                    \pagebreak

            \begin{center}
                Quantile plot for 100 benchmarks: Storm(87/96), PRISM(44/52), PRISM-TUM(9/24), mcsta(54/69), modes(22/29), STAMINA(1/3), DFTRES(10/12).Default configuration.
                \quantileplot{all.csv}{Storm,PRISM,PRISM-TUM,mcsta,modes,STAMINA,DFTRES}
            \end{center}
                    
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(87/96), PRISM(46/52), PRISM-TUM(6/24), mcsta(56/69), modes(21/29), STAMINA(1/3), DFTRES(10/12).Specific configuration.
                \quantileplot{specificall.csv}{Storm,PRISM,PRISM-TUM,mcsta,modes,STAMINA,DFTRES}
            \end{center}
                    \pagebreak

            \begin{center}
                Scatter Plot for Storm with default settings (n=96).
                \scatterplot{scatterStorm.csv}{Storm}{\tool{Storm}  (default, fastest on 49/96)}
            \end{center}
            ...
            \begin{center}
                ...
                \scatterplot{scatterspecificPRISM.csv}{PRISM}{\tool{PRISM}  (specific, fastest on 8/52)}
            \end{center}
                \pagebreak
