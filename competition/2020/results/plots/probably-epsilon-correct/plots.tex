\documentclass{article}
    ...
    \begin{document}
            \begin{center}
                Quantile plot for 86 benchmarks: mcsta(64/86), Storm(77/86), Storm-static(69/86).Default configuration.
                \quantileplot{janitools.csv}{mcsta,Storm,Storm-static}
            \end{center}
                    
            \begin{center}
                Quantile plot for 86 benchmarks: mcsta(65/86), Storm(77/86), Storm-static(77/86).Specific configuration.
            ...
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(87/96), Storm-static(78/96), mcsta(66/88), PRISM(44/52), PRISM-TUM(9/24), modes(27/32), STAMINA(1/3), DFTRES(10/12).Default configuration.
                \quantileplot{all.csv}{Storm,Storm-static,mcsta,PRISM,PRISM-TUM,modes,STAMINA,DFTRES}
            \end{center}
                    
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(87/96), Storm-static(87/96), mcsta(67/88), PRISM(46/52), PRISM-TUM(6/24), modes(27/32), STAMINA(1/3), DFTRES(10/12).Specific configuration.
            ...
            \begin{center}
                ...
                \scatterplot{scatterStorm.csv}{Storm}{\tool{Storm}  (default, fastest on 29/96)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm with specific settings (n=96).
                \scatterplot{scatterspecificStorm.csv}{Storm}{\tool{Storm}  (specific, fastest on 22/96)}
            \end{center}
                \pagebreak
            ...
            \begin{center}
                ...
                \scatterplot{scatterspecificStorm-static.csv}{Storm-static}{\tool{Storm-static}  (specific, fastest on 19/96)}
            \end{center}
                \pagebreak

            \begin{center}
                Scatter Plot for mcsta with default settings (n=88).
                \scatterplot{scattermcsta.csv}{mcsta}{\tool{mcsta}  (default, fastest on 19/88)}
            \end{center}
                
            \begin{center}
                Scatter Plot for mcsta with specific settings (n=88).
                \scatterplot{scatterspecificmcsta.csv}{mcsta}{\tool{mcsta}  (specific, fastest on 20/88)}
            \end{center}
                \pagebreak

            \begin{center}
                Scatter Plot for PRISM with default settings (n=52).
                \scatterplot{scatterPRISM.csv}{PRISM}{\tool{PRISM}  (default, fastest on 5/52)}
            \end{center}
