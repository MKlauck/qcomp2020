\documentclass{article}
    ...
    \begin{document}
            ...
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(86/96), Storm-static(77/96), mcsta(54/69), PRISM(45/52), PRISM-TUM(9/24).Default configuration.
                \quantileplot{all.csv}{Storm,Storm-static,mcsta,PRISM,PRISM-TUM}
            \end{center}
                    
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(86/96), Storm-static(86/96), mcsta(56/69), PRISM(47/52), PRISM-TUM(9/24).Specific configuration.
            ...
            \begin{center}
                ...
                \scatterplot{scatterStorm.csv}{Storm}{\tool{Storm}  (default, fastest on 55/96)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm with specific settings (n=96).
                \scatterplot{scatterspecificStorm.csv}{Storm}{\tool{Storm}  (specific, fastest on 25/96)}
            \end{center}
                \pagebreak

            \begin{center}
                Scatter Plot for Storm-static with default settings (n=96).
                \scatterplot{scatterStorm-static.csv}{Storm-static}{\tool{Storm-static}  (default, fastest on 14/96)}
            \end{center}
            ...
            \begin{center}
                ...
                \scatterplot{scatterspecificmcsta.csv}{mcsta}{\tool{mcsta}  (specific, fastest on 11/69)}
            \end{center}
                \pagebreak
