\documentclass{article}
    ...
    \begin{document}
            ...
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(86/96), Storm-static(77/96), PRISM(45/52), mcsta(65/88), PRISM-TUM(9/24).Default configuration.
                \quantileplot{all.csv}{Storm,Storm-static,PRISM,mcsta,PRISM-TUM}
            \end{center}
                    
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(86/96), Storm-static(86/96), PRISM(47/52), mcsta(66/88), PRISM-TUM(9/24).Specific configuration.
                \quantileplot{specificall.csv}{Storm,Storm-static,PRISM,mcsta,PRISM-TUM}
            \end{center}
                    \pagebreak

            \begin{center}
                Scatter Plot for Storm with default settings (n=96).
                \scatterplot{scatterStorm.csv}{Storm}{\tool{Storm}  (default, fastest on 54/96)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm with specific settings (n=96).
                \scatterplot{scatterspecificStorm.csv}{Storm}{\tool{Storm}  (specific, fastest on 51/96)}
            \end{center}
                \pagebreak

            \begin{center}
                Scatter Plot for Storm-static with default settings (n=96).
                \scatterplot{scatterStorm-static.csv}{Storm-static}{\tool{Storm-static}  (default, fastest on 34/96)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm-static with specific settings (n=96).
                \scatterplot{scatterspecificStorm-static.csv}{Storm-static}{\tool{Storm-static}  (specific, fastest on 54/96)}
            \end{center}
                \pagebreak

            \begin{center}
                Scatter Plot for PRISM with default settings (n=52).
                \scatterplot{scatterPRISM.csv}{PRISM}{\tool{PRISM}  (default, fastest on 15/52)}
            \end{center}
            ...
            \begin{center}
                ...
                \scatterplot{scattermcsta.csv}{mcsta}{\tool{mcsta}  (default, fastest on 34/88)}
            \end{center}
        ...
        \begin{center}
            ...
            \scatterplot{scatter_storm_vs_static.csv}{Storm}{\tool{Storm}  (default, fastest on 63/96)}
        \end{center}
            
        \begin{center}
            Scatter Plot for Storm vs. Storm-static with specific settings (n=96).
            \scatterplot{scatter_storm_vs_staticspecific.csv}{Storm}{\tool{Storm}  (specific, fastest on 30/96)}
        \end{center}
            \pagebreak
\end{document}
