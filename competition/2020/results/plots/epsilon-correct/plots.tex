...
\begin{document}
        ...
        \begin{center}
             Quantile plot for 100 benchmarks: Storm(86/96), PRISM(45/52), PRISM-TUM(9/24), mcsta(54/69).Default configuration.
            \quantileplot{all.csv}{Storm,PRISM,PRISM-TUM,mcsta}
        \end{center}
                
        \begin{center}
             Quantile plot for 100 benchmarks: Storm(86/96), PRISM(47/52), PRISM-TUM(9/24), mcsta(56/69).Specific configuration.
            \quantileplot{specificall.csv}{Storm,PRISM,PRISM-TUM,mcsta}
        \end{center}
                \pagebreak

        \begin{center}
            Scatter Plot for Storm with default settings (n=96).
            \scatterplot{scatterStorm.csv}{Storm}{\tool{Storm}  (default, fastest on 69/96)}
        \end{center}
            
        \begin{center}
            Scatter Plot for Storm with specific settings (n=96).
            \scatterplot{scatterspecificStorm.csv}{Storm}{\tool{Storm}  (specific, fastest on 60/96)}
        \end{center}
            \pagebreak
        ...
        \begin{center}
            ...
            \scatterplot{scatterspecificPRISM.csv}{PRISM}{\tool{PRISM}  (specific, fastest on 12/52)}
        \end{center}
            \pagebreak
        ...
        \begin{center}
            ...
            \scatterplot{scatterspecificmcsta.csv}{mcsta}{\tool{mcsta}  (specific, fastest on 13/69)}
        \end{center}
            \pagebreak
\end{document}
