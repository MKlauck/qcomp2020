\documentclass{article}
    ...
    \begin{document}
            ...
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(86/96), PRISM(53/58), PRISM-TUM(9/24), mcsta(52/69), modes(17/29), STAMINA(1/3), DFTRES(5/12), ModestFRETpiLRTDP(11/31).Default configuration.
                \quantileplot{all.csv}{Storm,PRISM,PRISM-TUM,mcsta,modes,STAMINA,DFTRES,ModestFRETpiLRTDP}
            \end{center}
                    
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(86/96), PRISM(55/58), PRISM-TUM(6/24), mcsta(53/69), modes(17/29), STAMINA(1/3), DFTRES(6/12), ModestFRETpiLRTDP(11/31).Specific configuration.
            ...
            \begin{center}
                ...
                \scatterplot{scatterspecificPRISM.csv}{PRISM}{\tool{PRISM}  (specific, fastest on 13/58)}
            \end{center}
                \pagebreak
