\documentclass{article}
    ...
    \begin{document}
            \begin{center}
                Quantile plot for 56 benchmarks: ePMC(21/56), mcsta(40/56), Storm(51/56), Storm-static(44/56).Default configuration.
                \quantileplot{janitools.csv}{ePMC,mcsta,Storm,Storm-static}
            \end{center}
                    
            \begin{center}
                Quantile plot for 56 benchmarks: ePMC(21/56), mcsta(41/56), Storm(51/56), Storm-static(51/56).Specific configuration.
                \quantileplot{specificjanitools.csv}{ePMC,mcsta,Storm,Storm-static}
            \end{center}
                    \pagebreak

            \begin{center}
                Quantile plot for 41 benchmarks: ePMC(18/41), mcsta(30/41), Storm(41/41), Storm-static(36/41), PRISM(38/41).Default configuration.
                \quantileplot{generalpurpose.csv}{ePMC,mcsta,Storm,Storm-static,PRISM}
            \end{center}
                    
            \begin{center}
                Quantile plot for 41 benchmarks: ePMC(18/41), mcsta(31/41), Storm(41/41), Storm-static(41/41), PRISM(39/41).Specific configuration.
                \quantileplot{specificgeneralpurpose.csv}{ePMC,mcsta,Storm,Storm-static,PRISM}
            \end{center}
                    \pagebreak

            \begin{center}
                Quantile plot for 100 benchmarks: Storm(86/96), Storm-static(77/96), mcsta(62/88), PRISM(54/58), PRISM-TUM(9/24), modes(19/32), STAMINA(1/3), DFTRES(5/12), ModestFRETpiLRTDP(11/31), ePMC(22/61), ePMC-6(31/61).Default configuration.
                \quantileplot{all.csv}{Storm,Storm-static,mcsta,PRISM,PRISM-TUM,modes,STAMINA,DFTRES,ModestFRETpiLRTDP,ePMC,ePMC-6}
            \end{center}
                    
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(86/96), Storm-static(86/96), mcsta(63/88), PRISM(56/58), PRISM-TUM(6/24), modes(19/32), STAMINA(1/3), DFTRES(6/12), ModestFRETpiLRTDP(11/31), ePMC(22/61), ePMC-6(31/61).Specific configuration.
            ...
            \begin{center}
                ...
                \scatterplot{scatterStorm.csv}{Storm}{\tool{Storm}  (default, fastest on 33/96)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm with specific settings (n=96).
                \scatterplot{scatterspecificStorm.csv}{Storm}{\tool{Storm}  (specific, fastest on 20/96)}
            \end{center}
                \pagebreak

            \begin{center}
                Scatter Plot for Storm-static with default settings (n=96).
                \scatterplot{scatterStorm-static.csv}{Storm-static}{\tool{Storm-static}  (default, fastest on 13/96)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm-static with specific settings (n=96).
                \scatterplot{scatterspecificStorm-static.csv}{Storm-static}{\tool{Storm-static}  (specific, fastest on 28/96)}
            \end{center}
                \pagebreak

            \begin{center}
                Scatter Plot for mcsta with default settings (n=88).
                \scatterplot{scattermcsta.csv}{mcsta}{\tool{mcsta}  (default, fastest on 18/88)}
            \end{center}
            ...
            \begin{center}
                ...
                \scatterplot{scatterPRISM.csv}{PRISM}{\tool{PRISM}  (default, fastest on 11/58)}
            \end{center}
            ...
            \begin{center}
                ...
                \scatterplot{scattermodes.csv}{modes}{\tool{modes}  (default, fastest on 6/32)}
            \end{center}
            ...
            \begin{center}
                ...
                \scatterplot{scatterspecificePMC.csv}{ePMC}{\tool{ePMC}  (specific, fastest on 0/61)}
            \end{center}
                \pagebreak
