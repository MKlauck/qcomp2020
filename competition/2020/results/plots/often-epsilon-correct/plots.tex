\documentclass{article}
    ...
    \begin{document}
            \begin{center}
                Quantile plot for 49 benchmarks: ePMC(16/49), mcsta(38/49), Storm(45/49), Storm-static(38/49).Default configuration.
                \quantileplot{janitools.csv}{ePMC,mcsta,Storm,Storm-static}
            \end{center}
                    
            \begin{center}
                Quantile plot for 49 benchmarks: ePMC(16/49), mcsta(39/49), Storm(45/49), Storm-static(45/49).Specific configuration.
                \quantileplot{specificjanitools.csv}{ePMC,mcsta,Storm,Storm-static}
            \end{center}
                    \pagebreak

            \begin{center}
                Quantile plot for 36 benchmarks: ePMC(13/36), mcsta(30/36), Storm(36/36), Storm-static(31/36), PRISM(33/36).Default configuration.
                \quantileplot{generalpurpose.csv}{ePMC,mcsta,Storm,Storm-static,PRISM}
            \end{center}
                    
            \begin{center}
                Quantile plot for 36 benchmarks: ePMC(13/36), mcsta(30/36), Storm(36/36), Storm-static(36/36), PRISM(34/36).Specific configuration.
                \quantileplot{specificgeneralpurpose.csv}{ePMC,mcsta,Storm,Storm-static,PRISM}
            \end{center}
                    \pagebreak

            \begin{center}
                Quantile plot for 100 benchmarks: Storm(86/96), Storm-static(77/96), mcsta(52/69), PRISM(54/58), PRISM-TUM(9/24), modes(17/29), STAMINA(1/3), DFTRES(5/12), ModestFRETpiLRTDP(11/31), ePMC(22/61).Default configuration.
                \quantileplot{all.csv}{Storm,Storm-static,mcsta,PRISM,PRISM-TUM,modes,STAMINA,DFTRES,ModestFRETpiLRTDP,ePMC}
            \end{center}
                    
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(86/96), Storm-static(86/96), mcsta(53/69), PRISM(56/58), PRISM-TUM(6/24), modes(17/29), STAMINA(1/3), DFTRES(6/12), ModestFRETpiLRTDP(11/31), ePMC(22/61).Specific configuration.
                \quantileplot{specificall.csv}{Storm,Storm-static,mcsta,PRISM,PRISM-TUM,modes,STAMINA,DFTRES,ModestFRETpiLRTDP,ePMC}
            \end{center}
                    \pagebreak

            \begin{center}
                Scatter Plot for Storm with default settings (n=96).
                \scatterplot{scatterStorm.csv}{Storm}{\tool{Storm}  (default, fastest on 45/96)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm with specific settings (n=96).
                \scatterplot{scatterspecificStorm.csv}{Storm}{\tool{Storm}  (specific, fastest on 23/96)}
            \end{center}
                \pagebreak

            \begin{center}
                Scatter Plot for Storm-static with default settings (n=96).
                \scatterplot{scatterStorm-static.csv}{Storm-static}{\tool{Storm-static}  (default, fastest on 15/96)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm-static with specific settings (n=96).
                \scatterplot{scatterspecificStorm-static.csv}{Storm-static}{\tool{Storm-static}  (specific, fastest on 31/96)}
            \end{center}
                \pagebreak
            ...
            \begin{center}
                ...
                \scatterplot{scatterspecificmcsta.csv}{mcsta}{\tool{mcsta}  (specific, fastest on 14/69)}
            \end{center}
                \pagebreak
            ...
            \begin{center}
                ...
                \scatterplot{scatterspecificPRISM.csv}{PRISM}{\tool{PRISM}  (specific, fastest on 11/58)}
            \end{center}
                \pagebreak
            ...
            \begin{center}
                ...
                \scatterplot{scatterePMC.csv}{ePMC}{\tool{ePMC}  (default, fastest on 2/61)}
            \end{center}
                
            \begin{center}
                Scatter Plot for ePMC with specific settings (n=61).
                \scatterplot{scatterspecificePMC.csv}{ePMC}{\tool{ePMC}  (specific, fastest on 2/61)}
            \end{center}
                \pagebreak
\end{document}
