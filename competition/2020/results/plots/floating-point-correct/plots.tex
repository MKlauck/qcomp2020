\documentclass{article}
    ...
    \begin{document}
            ...
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(51/79), mcsta(49/69).Default configuration.
                \quantileplot{all.csv}{Storm,mcsta}
            \end{center}
                    
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(51/79), mcsta(50/69).Specific configuration.
            ...
            \begin{center}
                ...
                \scatterplot{scatterStorm.csv}{Storm}{\tool{Storm}  (default, fastest on 47/79)}
            \end{center}
