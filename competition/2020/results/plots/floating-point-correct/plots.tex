\documentclass{article}
    ...
    \begin{document}
            \begin{center}
                Quantile plot for 67 benchmarks: mcsta(47/67), Storm(45/67), Storm-static(34/67).Default configuration.
                \quantileplot{janitools.csv}{mcsta,Storm,Storm-static}
            \end{center}
                    
            \begin{center}
                Quantile plot for 67 benchmarks: mcsta(48/67), Storm(45/67), Storm-static(44/67).Specific configuration.
            ...
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(51/79), Storm-static(39/79), mcsta(49/69).Default configuration.
                \quantileplot{all.csv}{Storm,Storm-static,mcsta}
            \end{center}
                    
            \begin{center}
                Quantile plot for 100 benchmarks: Storm(51/79), Storm-static(50/79), mcsta(50/69).Specific configuration.
            ...
            \begin{center}
                ...
                \scatterplot{scatterStorm-static.csv}{Storm-static}{\tool{Storm-static}  (default, fastest on 6/79)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm-static with specific settings (n=79).
                \scatterplot{scatterspecificStorm-static.csv}{Storm-static}{\tool{Storm-static}  (specific, fastest on 32/79)}
            \end{center}
                \pagebreak
            ...
            \begin{center}
                ...
                \scatterplot{scatterspecificmcsta.csv}{mcsta}{\tool{mcsta}  (specific, fastest on 21/69)}
            \end{center}
                \pagebreak
\end{document}
