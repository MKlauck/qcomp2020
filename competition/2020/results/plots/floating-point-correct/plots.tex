...
\begin{document}
        \begin{center}
             Quantile plot for 79 benchmarks: Storm(52/79).Default configuration.
            \quantileplot{janitools.csv}{Storm}
        \end{center}
                
        \begin{center}
             Quantile plot for 79 benchmarks: Storm(52/79).Specific configuration.
        ...
        \begin{center}
             Quantile plot for 100 benchmarks: Storm(52/79).Default configuration.
            \quantileplot{all.csv}{Storm}
        \end{center}
                
        \begin{center}
             Quantile plot for 100 benchmarks: Storm(52/79).Specific configuration.
        ...
        \begin{center}
            ...
            \scatterplot{scatterspecificStorm.csv}{Storm}{\tool{Storm}  (specific, fastest on 52/79)}
        \end{center}
            \pagebreak
\end{document}
