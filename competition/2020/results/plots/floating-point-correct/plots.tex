\documentclass{article}
    ...
    \begin{document}
            \begin{center}
                Quantile plot for 67 benchmarks: mcsta(44/67), Storm(45/67), Storm-static(34/67).Default configuration.
                \quantileplot{janitools.csv}{mcsta,Storm,Storm-static}
            \end{center}
                    
            \begin{center}
                Quantile plot for 67 benchmarks: mcsta(46/67), Storm(45/67), Storm-static(44/67).Specific configuration.
            ...
            \begin{center}
                ...
                \scatterplot{scatterStorm.csv}{Storm}{\tool{Storm}  (default, fastest on 36/79)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm with specific settings (n=79).
                \scatterplot{scatterspecificStorm.csv}{Storm}{\tool{Storm}  (specific, fastest on 11/79)}
            \end{center}
                \pagebreak

            \begin{center}
                Scatter Plot for Storm-static with default settings (n=79).
                \scatterplot{scatterStorm-static.csv}{Storm-static}{\tool{Storm-static}  (default, fastest on 5/79)}
            \end{center}
                
            \begin{center}
                Scatter Plot for Storm-static with specific settings (n=79).
                \scatterplot{scatterspecificStorm-static.csv}{Storm-static}{\tool{Storm-static}  (specific, fastest on 31/79)}
            \end{center}
                \pagebreak

            \begin{center}
                Scatter Plot for mcsta with default settings (n=69).
                \scatterplot{scattermcsta.csv}{mcsta}{\tool{mcsta}  (default, fastest on 22/69)}
            \end{center}
